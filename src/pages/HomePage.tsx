            ...
            <section className={`rounded-3xl p-8 md:p-12 shadow-lg ${themeClasses.cardBg} ${themeClasses.border} border transition-colors duration-500`}>
                <div className="md:flex md:items-center md:space-x-12">
                    ...
                    <div className="md:w-1/2">
                        <img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1974&auto=format&fit=crop" alt="Team meeting" className="h-64 w-full rounded-2xl object-cover" />
                    </div>
                </div>
            </section>
