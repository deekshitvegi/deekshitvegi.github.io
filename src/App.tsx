...
const App: React.FC = () => {
    const [theme, setTheme] = useState<Theme>(
      () => (localStorage.getItem('vkt-theme') as Theme) || 'light'
    );
    ...
    }, [currentPage, themeClasses, navigate]);
    ...
    return (
        <div className={`${themeClasses.mainBg} ${themeClasses.text} min-h-screen font-sans transition-colors duration-500 relative`}>
            ...
            <Header theme={theme} themeClasses={themeClasses} toggleTheme={() => setTheme(t => t === 'light' ? 'dark' : 'light')} setCurrentPage={navigate} currentPage={currentPage} openSearch={openSearch} />
            
            {isHomePage && <HeroSlideshow setCurrentPage={navigate} themeClasses={themeClasses} />}
