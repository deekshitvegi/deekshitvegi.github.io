                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-5">
                            <a href="https://www.hytera.com/" target="_blank" rel="noopener noreferrer" className="flex items-center grayscale hover:grayscale-0 transition-all duration-300">
                                <img src="/hytera-logo-gs.png" alt="Hytera" className="h-6" />
                            </a>
                            <a href="https://www.motorolasolutions.com/" target="_blank" rel="noopener noreferrer" className="flex items-center grayscale hover:grayscale-0 transition-all duration-300">
                                <img src="/motorola-logo-gs.png" alt="Motorola Solutions" className="h-6" />
                            </a>
                            <a href="https://www.kenwood.com/usa/com/" target="_blank" rel="noopener noreferrer" className="flex items-center grayscale hover:grayscale-0 transition-all duration-300">
                                <img src="/kenwood-logo-gs.png" alt="Kenwood" className="h-5" />
                            </a>
                        </div>
                    </div>
                </div>
